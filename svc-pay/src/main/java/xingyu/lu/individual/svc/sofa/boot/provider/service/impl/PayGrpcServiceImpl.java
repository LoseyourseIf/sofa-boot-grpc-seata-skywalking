...
@Service
@DS("pay")
@SofaService(uniqueId = "Pay-Grpc", interfaceType = SofaXServiceTriple.IXService.class,
...
public class PayGrpcServiceImpl extends SofaXServiceTriple.XServiceImplBase implements SofaGrpcService {
    ...
    public String biz(String param) {
        ...
        PayBaseService.orderPay(orders, log, accountMapper);
